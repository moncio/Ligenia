...
import { authenticate, authorize, AuthRequest } from '../../../../src/api/middlewares/auth.middleware';
...
describe('Auth Middleware Unit Tests', () => {
  ...
  describe('authenticate', () => {
    it('should call next() when valid token is provided', async () => {
      ...
      // Execute
      await authenticate(mockRequest as AuthRequest, mockResponse as Response, mockNext as NextFunction);
  ...
  describe('authorize', () => {
    it('should call next() if user has the required role', async () => {
      ...
      // Execute
      await middleware(mockRequest as AuthRequest, mockResponse as Response, mockNext as NextFunction);
