import { CalculatePlayerRankingsUseCase, CalculatePlayerRankingsInput } from '../../../../src/core/application/use-cases/ranking/calculate-player-rankings.use-case';
...
describe('CalculatePlayerRankingsUseCase', () => {
  ...
  it('should fail when statistics not found for player', async () => {
    ...
    const playerWithoutStats = new Player(
      playerWithoutStatsId, 
      'user4', 
      PlayerLevel.P1, 
      22, 
      'USA'
