import { GetTournamentBracketUseCase, GetTournamentBracketInput } from '../../../../src/core/application/use-cases/tournament/get-tournament-bracket.use-case';
...
describe('GetTournamentBracketUseCase', () => {
  ...
  beforeEach(() => {
    useCase = new GetTournamentBracketUseCase(
  ...
  function createMatch(id: string, round: number, player1Id: string, player2Id: string, status: MatchStatus = MatchStatus.PENDING): Match {
    return new Match(
      id,
      tournamentId,
      player1Id,
