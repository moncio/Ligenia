...
describe('Player API Integration Tests', () => {
  ...
  describe('GET /api/players', () => {
    it('should return a list of players for admin', async () => {
      const response = await agent.get('/api/players').set('Authorization', 'Bearer admin-token');
    ...
    it('should return 403 when player tries to access all players', async () => {
      const response = await agent.get('/api/players').set('Authorization', 'Bearer valid-token');
  ...
  describe('GET /api/players/:id', () => {
    it('should return a specific player by ID', async () => {
      ...
      const response = await agent.get(`/api/players/${testData?.playerUser?.id || nonExistentId}`);
    ...
    it('should return 404 for non-existent player ID', async () => {
      const response = await agent.get(`/api/players/${nonExistentId}`);
  ...
  describe('POST /api/players', () => {
    ...
    it('should return 401 when not authenticated', async () => {
      const response = await agent.post('/api/players').send(createPlayerData);
  ...
  describe('DELETE /api/players/:id', () => {
    it('should allow administrators to delete players', async () => {
      ...
      await prisma.user
        .delete({ where: { id: tempUser.id } })
        .catch(e => console.error('Error deleting temp user:', e));
    });
    ...
    it('should return 401 when not authenticated', async () => {
      const response = await agent.delete(
        `/api/players/${testData?.playerUser?.id || nonExistentId}`,
      );
  ...
  describe('GET /api/players/:id/statistics', () => {
    it('should return statistics for a specific player', async () => {
      const response = await agent.get(
        `/api/players/${testData?.playerUser?.id || nonExistentId}/statistics`,
      );
    ...
    it('should return 404 for non-existent player', async () => {
      const response = await agent.get(`/api/players/${nonExistentId}/statistics`);
    ...
    it('should return 400 for invalid player ID format', async () => {
      const response = await agent.get(`/api/players/${invalidFormatId}/statistics`);
  ...
  describe('GET /api/players/:id/matches', () => {
    it('should return matches for a specific player', async () => {
      const response = await agent.get(
        `/api/players/${testData?.playerUser?.id || nonExistentId}/matches`,
      );
    ...
    it('should return 404 for non-existent player', async () => {
      const response = await agent.get(`/api/players/${nonExistentId}/matches`);
    ...
    it('should return 400 for invalid player ID format', async () => {
      const response = await agent.get(`/api/players/${invalidFormatId}/matches`);
  ...
  describe('GET /api/players/:id/tournaments', () => {
    it('should return tournaments for a specific player', async () => {
      const response = await agent.get(
        `/api/players/${testData?.playerUser?.id || nonExistentId}/tournaments`,
      );
    ...
    it('should return 404 for non-existent player', async () => {
      const response = await agent.get(`/api/players/${nonExistentId}/tournaments`);
    ...
    it('should return 400 for invalid player ID format', async () => {
      const response = await agent.get(`/api/players/${invalidFormatId}/tournaments`);
